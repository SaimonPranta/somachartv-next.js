...
const Index = async ({ params: { id } }) => {
    ...
    return (
        <>
            <MetaHead title={newsDetails.title} description={newsDetails.description} image={getImageUrl(newsDetails.images)}/>
            <Header />
                ...
                <div className=' news-details'>
                    <div className="main-news-container">
                        ...
                        <div className="news-container" id="news-container">
                            ...
                            <Image src={getImageUrl(newsDetails.images)} height="100" width="100" alt="" />
