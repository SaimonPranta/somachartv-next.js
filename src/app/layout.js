...
export const metadata = {
  ...
  description: "Somachar TV: Uncover the truth with insightful reporting and a commitment to authentic storytelling. Stay informed and engaged!",
  keywords: "Somachar TV, news, journalism, truth, insights, articles, unbiased reporting, current events, media",
  author: "Somachar TV",
  ...
  return (
    <html lang="bn">
      <head>
        ...
        <meta name="google-adsense-account" content="ca-pub-7281991904831824"></meta>
