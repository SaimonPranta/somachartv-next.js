...
const Page = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        if(!input.name || !input.fatherName ||  !input.motherName || !input.password || !input.dateOfBirth || !input.email || !input.position || !input.idNumber ||!input.joinDate || !input.idCardExpDate || !input.address || !input.images){
            return 
        }
